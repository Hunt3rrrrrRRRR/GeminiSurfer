...
export const StarIcon: React.FC<IconProps> = ({ className, fill = "none" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill={fill} viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
...
export const MagnifyingGlass: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
